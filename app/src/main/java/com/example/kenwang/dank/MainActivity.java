...
public class MainActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        Button btnTownHall = (Button) findViewById(R.id.buttonTownHall);
        btnTownHall.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View view) {
                baseLocation = "TownHall";
                Intent startIntent = new Intent(getApplicationContext(),displayTransportList.class);
                startIntent.putExtra("startLocation",baseLocation);
                startActivity(startIntent);
            }
        });


        Button btnMacq = (Button) findViewById(R.id.buttonMacq);
        btnMacq.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View view) {
                baseLocation ="Macq";
                Intent startIntent = new Intent(getApplicationContext(),displayTransportList.class);
        ...
        Button click = (Button) findViewById(R.id.buttonHome);
